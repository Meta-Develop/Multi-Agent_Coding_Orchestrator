//! Content-addressing helper shared by trust-lane optimizer modules.
//!
//! SHA-256 is implemented locally so this crate does not take a hashing
//! dependency. The implementation matches FIPS 180-4.
